...
public class PySqueezeNet implements Generator {
    ...
    public PySqueezeNet(Image contentImage, Image styleImage) {
        this.contentImage = SwingFXUtils.fromFXImage(contentImage, null);
        this.styleImage = SwingFXUtils.fromFXImage(styleImage, null);
    }
    ...
    public Image generate() throws GenerationException {
        ...
        //return SwingFXUtils.toFXImage(contentImage, null);
    }
}
